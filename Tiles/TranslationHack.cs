...
public class TranslationHack {
	private void NotToBecalled () {
		...
		Catalog.GetString ("Weblog:");
		/* For translators: From template Tiles/template-blog.html */
		Catalog.GetString ("by");
		/* For translators: From template Tiles/template-blog.html */
		Catalog.GetString ("Published:");
		/* For translators: From template Tiles/template-blog.html */
		Catalog.GetString ("Open");
		/* For translators: From template Tiles/template-docs.html */
		Catalog.GetString ("in folder");
		/* For translators: From template Tiles/template-docs.html */
		Catalog.GetString ("Last modified");
		/* For translators: From template Tiles/template-docs.html */
		...
		Catalog.GetString ("Open");
		/* For translators: From template Tiles/template-docs.html */
		Catalog.GetString ("Send to...");
		/* For translators: From template Tiles/template-docs.html */
		Catalog.GetString ("Reveal in file manager");
		...
		Catalog.GetString ("Last viewed:");
		/* For translators: From template Tiles/template-web-history.html */
		Catalog.GetString ("Open");
		/* For translators: From template Tiles/template-network.html */
		Catalog.GetString ("from Networked Beagle on host");
		/* For translators: From template Tiles/template-network.html */
		Catalog.GetString ("Open");
		/* For translators: From template Tiles/template-network.html */
		Catalog.GetString ("Search Networked Beagle");
