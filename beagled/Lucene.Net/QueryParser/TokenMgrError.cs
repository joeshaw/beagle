...
namespace Lucene.Net.QueryParsers
{
	public class TokenMgrError : Exception
	{
		...
		/// </summary>
		/// <param name="EOFSeen">indicates if EOF caused the lexicl error</param>
		/// <param name="lexState">lexical state in which this error occured</param>
		/// <param name="errorLine">line number when the error occured</param>
		/// <param name="errorColumn">column number when the error occured</param>
		/// <param name="errorAfter">prefix that was seen before this error occured</param>
