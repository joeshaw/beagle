...
namespace Lucene.Net.Index
{
	...
	public class IndexWriter
	{
        ...
        /// </summary>
        public static readonly int DEFAULT_TERM_INDEX_INTERVAL = System.Int32.Parse(SupportClass.AppSettings.Get("Lucene.Net.termIndexInterval", "128"));
		...
		private void  MergeSegments(int minSegment)
		{
            ...
            if (useCompoundFile)
            {
                //UPGRADE_NOTE: Final was removed from the declaration of 'filesToDelete '. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1003_3"'
                System.Collections.ArrayList filesToDelete = merger.CreateCompoundFile(mergedName + ".tmp");
                lock (directory)
                {
                    // in- & inter-process sync
